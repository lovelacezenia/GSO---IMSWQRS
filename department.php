                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                            <!-- department dropdown -->
                                <button type="button" class="btn btn-info" data-toggle="modal" data-target="#myModal">Department</button>
                            </div>
                                ...
                                <table id="table1" class="table table-striped" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td></td>
                                            <td></td>
                                            <td><button class="btn btn-primary btn-xs"><span class="glyphicon glyphicon-info-sign"></span>
                                                <a href="department_view.php">
                                                </button></td>
                                        </tr>
                                        <tr>
                                            <td></td>
